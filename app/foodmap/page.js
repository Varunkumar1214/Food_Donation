    ...
    const foodCenters = [
        {
            ...
            description:
                'At Fortunestown, our hardworking team transforms surplus food into a true lifeline for our people. Every day, we collect extra food from local vendors and swiftly share it with those in need, driven by our spirit of seva and heartfelt care.',
        ...
        },
        {
            ...
            description:
                'At the Dublin centre, community engagement is at our core. Our dedicated volunteers work hand-in-hand with local organisations to ensure every morsel of surplus food is put to good use, reflecting our deep commitment to humanity.',
        ...
        <div className="mt-8 min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-12 px-4">
            ...
            <section className="mb-16">
                <SectionTitle
                    ...
                    subtitle="Our food centres are the heart and soul of our mission. Located in the vibrant neighbourhoods of Fortunestown, Dublin, and Dublin, these centres do more than just gather surplus food from local vendors they spread hope and care throughout our community. Every day, our dedicated team works with the spirit of ‘seva’  to ensure that every morsel of extra food is shared with those who need it most. In our food centres, we don’t just collect food, we nurture bonds, uplift lives, and create a strong sense of unity and compassion among all"
                />
